...
def not_so_tricky_method(a_string_param, an_array_param)
  ...
  return a_string_param, an_array_param # this is important
end
...
# A common idiom used to solve this conundrum is to use the String#split in
# conjunction with Array#join methods to break our string up and then put it
# back together again.
...
sentence_reversed = sentence_array.reverse
backwards_sentence = sentence_reversed.join(" ") + "."
...
# This will print 34
# This is because the mess_with_it method does not mutate the answer variable
...
# mess_with_demographics changes the data of the musters hash
# this is because hashes are mutated when inidividual values are referenceda and
# reassigned
...
# foo always returns "yes" no matter  parameter is given.
# Therefore bar is passed the string "yes" - bar("yes")
# therefore bar returns "no"
